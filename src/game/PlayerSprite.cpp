...
// RGBA palette
static constexpr unsigned char T[]  = {0, 0, 0, 0};         // transparent
static constexpr unsigned char G[]  = {80, 200, 100, 255};  // green
static constexpr unsigned char D[]  = {40, 120, 60, 255};   // dark green
static constexpr unsigned char Wh[] = {255, 255, 255, 255}; // white
static constexpr unsigned char B[]  = {30, 30, 30, 255};    // black
static constexpr unsigned char A[]  = {160, 160, 160, 255}; // gray antenna
static constexpr unsigned char Y[]  = {240, 200, 0, 255};   // yellow tip

std::unique_ptr<Texture> createPlayerTexture() {
